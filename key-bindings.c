...
key_bindings_init(void)
{
	static const char *const defaults[] = {
		...
		"bind -N 'Switch to a window' W { new-pane -E -x75% -y30% -X0 -Y0; move-pane -P bottom-centre; switch-mode -wk }",
		"bind -N 'Switch to a session' S { new-pane -E -x75% -y30% -X0 -Y0; move-pane -P bottom-centre; switch-mode -sk }",
